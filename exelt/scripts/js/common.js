...
function load_page_init(baseUrl) {
  ...
  $("#xlt-header").load(baseUrl + "/top.html?v=2024.08.28.00", null, ()=>{
    topLoaded = true;
  ...
  if ($("#xlt-contact").length > 0) {
    $("#xlt-contact").load(baseUrl + "/bottom-contacts.html?v=2024.08.28.00", null, ()=>{
      contactLoaded = true;
      if( topLoaded && bottomLoaded && contactLoaded ) {
        onTopBottomReady();
      }
  ...
  $("#xlt-footer").load(baseUrl + "/bottom.html?v=2024.08.28.00", null, ()=>{
    bottomLoaded = true;
    if( topLoaded && bottomLoaded && contactLoaded ) {
      onTopBottomReady();
    }
