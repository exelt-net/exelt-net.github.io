...
var data = {
  en: {
    ...
    our_service_type_title2: 'Governments',
    ...
    school_comments_des211: 'Bespoke courses to fit your school’s curriculum and culture, and to match your students’ needs and interests.',
    school_comments_des212: 'Exciting multi-media, real-world speaking tasks, kinesthetic and competitive activities are built into all our courses, meaning you get the maximum engagement with the minimum preparation time.',
    ...
    //school_comments_des31: 'Our courses contain clear and easy-to-follow guidelines for teachers, which can be translated into any language. Our software provides help with pronunciation of all key language items, and all guides to setting up lessons come with video instruction and can be provided in English or the teacher’s mother tongue. Our software allows teachers to develop their own accuracy and awareness of typical errors as they go. In addition, our consultants are highly experienced teacher trainers and are available to provide focused feedback and help with language and teaching techniques, either face to face or online. This approach enables teachers with limited English ability to deliver English programs effectively and develop their own ability on a unit-by-unit, lesson-by-lesson basis. With our help, they do not need to be advanced English speakers or rely on foreign teachers to provide a high-quality learning experience for their students, and they are able to become increasingly confident and independent with every course they deliver.',
    school_comments_des31: 'Our Solutions:',
    school_comments_des311: 'Courses with clear and easy-to-follow guidelines for teachers, which can be translated into any language.',
    school_comments_des312: 'Help with pronunciation of all key language items.',
    school_comments_des313: 'Optional teacher support and assessment from our team of highly experienced teacher trainers, face-to-face or online.',
    ...
    ind_comments_des111: 'Give small business owners, tourism industry workers and local people the confidence to communicate with visitors in English.',
    ...
    ind_comments_des211: 'Our software can be used to transform a national education system, with tailor-made courses suited to the exact needs and culture of the students.',
    ind_comments_des212: 'Significant savings can be made as the reliance on expensive, international course books is reduced.',
    ...
    ind_comments_des214: 'Our digital platform can be used to reach learners in every corner of your country, whatever their learning situation.',
    ...
    ind_comments_des311: 'Our software can be used to provide vocational training to all sectors of society, from traditional industries, such as agriculture and manufacturing, to emerging industries.',
    ind_comments_des312: 'Tailor-made courses can be updated at any time, giving your workforce continuous access to the most advanced methods and equipment.',
    ind_comments_des313: 'Training courses can be translated into your language, digitized and sent to any part of your country, and turned into pictorial or video instruction to overcome any literacy issues.',
    // ind_comments_title11: 'We need to develop language and communication skills at all levels of society to show our country in its best possible light."',
    // ind_comments_title12: 'Connect with the world',
    // ind_comments_des12: 'We can provide language courses for all sectors of society, easily downloaded onto their device at any time. We can give small business owners, tourism industry workers and local people the confidence to communicate with visitors in English. We can give workers the communication skills to access the international jobs market and help executives present their ideas to the world, encourage investment and negotiate the best possible outcomes. At every level of society, our learning systems can enable a country to show its best attributes to the world.',
    // ind_comments_title21: '“We need the best possible education system, from young learners through to postgraduate and vocational training, in order to create a skilled workforce and prosperous society.”',
    // ind_comments_title22: 'Transform your education system',
    // ind_comments_des22: 'Our software can be used to transform a national education system, with tailor-made courses suited to the exact needs and culture of the students. Significant savings can be made as the reliance on expensive, international course books is reduced, and our digital platform can be used to reach learners in every corner of the country, whatever their learning situation.',
    ind_comments_title31: '“Now, perhaps more than ever, we need job creation and professional training schemes.”',
    ind_comments_title32: 'Create jobs and skilled workers',
    ind_comments_des32: 'From traditional industries, such as agriculture and manufacturing, to emerging industries, our software can be used to provide vocational training to all sectors of society. Our digital platform makes it easy to accumulate knowledge from a range of sources and deliver it to anyone, regardless of their situation or location. Tailor-made courses can be updated at any time, giving your workforce continuous access to the most advanced strategies, methods and technologies. In addition to tailor-made courses, our language learning services can give your students the language skills they need to access any course in the world that uses EMI (English as a method of instruction). Whether providing general English development, language preparation for a specific course, or both, we can open up a world of courses to your students',
    ...
    about_composition_des1: 'Exelt represents a global network of education strategists, writers and consultants, combined with master programmers, designers and app developers. We have one mission: to bring the best possible education and training to those who need it through a combination of innovative software and the highest quality of course design and consultancy services. Our relationship with clients is a truly collaborative process; we bring a wealth of experience to any project but take pride in meeting our clients’ exact needs, continuously listening and adapting content until we have achieved the perfect outcome for our clients.',
