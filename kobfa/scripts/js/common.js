...
$(document).ready(function (e) {
  $("#xlt-header").load("./top.html?v=2023.07.09.00", null, () => {
    topLoaded = true;
  ...
  if ($("#xlt-contact").length > 0) {
    $("#xlt-contact").load("./bottom-contacts.html?v=2023.07.09.00", null, () => {
      contactLoaded = true;
      if (topLoaded && bottomLoaded && contactLoaded) {
        onTopBottomReady();
      }
  ...
  $("#xlt-footer").load("./bottom.html?v=2023.07.09.00", null, () => {
    bottomLoaded = true;
    if (topLoaded && bottomLoaded && contactLoaded) {
      onTopBottomReady();
    }
