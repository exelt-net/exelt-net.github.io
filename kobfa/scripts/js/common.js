...
$(document).ready(function (e) {
  $("#xlt-header").load("./top.html?v=2024.07.24.01", null, () => {
    topLoaded = true;
  ...
  if ($("#xlt-contact").length > 0) {
    $("#xlt-contact").load("./bottom-contacts.html?v=2024.07.24.01", null, () => {
      contactLoaded = true;
      if (topLoaded && bottomLoaded && contactLoaded) {
        onTopBottomReady();
      }
  ...
  $("#xlt-footer").load("./bottom.html?v=2024.07.24.01", null, () => {
    bottomLoaded = true;
    if (topLoaded && bottomLoaded && contactLoaded) {
      onTopBottomReady();
    }
