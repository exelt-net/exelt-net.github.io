...
var data = {
  en: {
    ...
    language_learning_des: 'We produce the most advanced educational software complemented by expert consultancy and a deep understanding of Thai culture. We provide a complete solution for any organization looking to provide high-quality and cost-effective academic, language-learning and training programs.',
    // How we work
    ...
    gov_comments_des212: 'Significant savings can be made as reliance on expensive, international course books is reduced',
    ...
    tefl_courses_comments_title11: 'The course is divided into three modules',
    tefl_courses_comments_des111: 'Module 1 is online study, allowing participants to study TEFL theory and techniques at their own pace and take part in practice and discussion sessions',
    ...
    tefl_courses_comments_des113: 'Module 3 consists of tasks for reflection, continued classroom experimentation and ongoing professional development',
    ...
    tefl_courses_comments_des22: 'These courses are often done over a longer period of time than traditional TEFL courses, in order to provide ongoing support as a teacher’s language level improves. The three modules combine online study with tutor support sessions, which can be done face-to-face or online to reduce costs.', 
    ...
    tefl_courses_comments_des241: 'Pre-lesson: Assisted lesson planning, language content and anticipated problems',
    tefl_courses_comments_des242: 'Observed teaching practice, live or recorded',
    tefl_courses_comments_des243: 'Lesson reflection and tutor feedback',
    tefl_courses_comments_des25: 'Module 3: Ongoing Professional Development',
    tefl_courses_comments_des251: 'Detailed plans for future lessons and skills development',
    tefl_courses_comments_des252: 'Tailor-made language development tasks for each teacher, based on their language needs and future lesson content',
    tefl_courses_comments_des253: 'Periodical observation, testing and assessment',
    tefl_courses_comments_des26: 'Language Level required: A1+',
    ...
    emi_courses_des11: 'This is a tailor-made course, created in collaboration with your school or university. It is designed to provide an introduction to EMI and generate interest in further study. The content is entirely flexible and can be delivered online, blended, or face-to-face as part of a ‘taster day’.',
    emi_courses_des12: 'Course content typically provides examples of useful classroom techniques and language, and also fun activities to show how lessons can be made interactive and engaging. It can be used as part of a marketing campaign with a custom-made unit based on studying at your learning institution. It can also form part of Module 1 of the larger EMI Foundation Course, encouraging participants to take their study further.',
    ...
    emi_courses_des2: 'This is a blended course giving teachers the key tools they need to deliver their lessons and lectures in English.',
    emi_courses_comments_des21: 'The course is divided into three modules',
    emi_courses_comments_des211: 'Module 1: Strategy, Techniques and Key Language',
    emi_courses_comments_des2111: 'Assessment of teaching situation, language level and needs',
    emi_courses_comments_des2112: 'Online tasks to develop awareness of the principles of EMI, useful techniques and key language',
    emi_courses_comments_des2113: 'Discussion and practice sessions with consultants',
    emi_courses_comments_des212: 'Module 2: Teaching and Language Practice',
    emi_courses_comments_des2121: 'Assisted lesson planning',
    emi_courses_comments_des2122: 'Observed teaching practice, live or recorded',
    emi_courses_comments_des2123: 'Lesson reflection and tutor feedback',
    emi_courses_comments_des2124: 'Language practice and assessment',
    emi_courses_comments_des213: 'Module 3: Ongoing Professional Development',
    emi_courses_comments_des2131: 'Detailed plans for future lessons and skills development',
    emi_courses_comments_des2132: 'Tailor-made language development tasks for each teacher, based on their language needs and future lesson content',
    emi_courses_comments_des2133: 'Testing and assessment and options for further observation',
    ...
    information_chris_o: 'Chris has been working in the ELT industry for over 25 years and has been based in East Asia since 2014. He has worked extensively in Thailand, China, and Japan, working for International House, Bell, and Cambridge University Press, among others. Chris is a specialist in teacher training and is a Cambridge University CELTA and DELTA trainer and course assessor. He is also Editor of the IH Journal and has written teaching materials for MacMillan, International House and publishers in Thailand. He has delivered presentations at numerous international conferences, including the CETA Symposium.',
  ...
  th: {
    ...
    language_learning_des: 'การเรียนรู้สำหรับทุกคน เราผลิตซอฟต์แวร์เพื่อการศึกษาที่ทันสมัยที่สุด ซึ่งเติมเต็มด้วยการให้คำปรึกษาจากผู้เชี่ยวชาญ และความเข้าใจในวัฒนธรรมไทยอย่างถ่องแท้ เรามีวิธีแก้ปัญหาอย่างครบถ้วนสำหรับองค์กรที่ต้องการจัดโปรแกรมการศึกษา การเรียนรู้ภาษา และการฝึกอบรมคุณภาพสูงและคุ้มค่า',
    // How we work (TH)
    ...
    tefl_courses_comments_title11: 'หลักสูตรนี้แบ่งออกเป็นสามโมดูล',
    tefl_courses_comments_des111: 'โมดูลที่ 1 เป็นการเรียนแบบออนไลน์ที่ให้ผู้เข้าเรียนศึกษาทฤษฎีและเทคนิค TEFL ด้วยตนเองตามต้องการ และมีส่วนร่วมในเซสชันการฝึกปฏิบัติและการอภิปราย',
    tefl_courses_comments_des112: 'โมดูลที่ 2 ประกอบไปด้วย input sessions แบบเรียนในชั้นเรียนที่ใช้งานได้จริง รวมถึงการปฏิบัติการสอนและการให้คำติชมโดยมีผู้สังเกตการณ์',
    tefl_courses_comments_des113: 'โมดูลที่ 3 ประกอบด้วยงานสำหรับการไตร่ตรอง การทดลองในชั้นเรียนอย่างต่อเนื่อง และการพัฒนาแบบมืออาชีพอย่างต่อเนื่อง',
    ...
    tefl_courses_comments_des22: 'หลักสูตรเหล่านี้มักจะใช้เวลานานกว่าหลักสูตร TEFL แบบดั้งเดิม เพื่อให้การสนับสนุนอย่างต่อเนื่องเนื่องจากระดับภาษาของครูผู้สอนก็จะดีขึ้น โมดูลทั้งสามได้รวมเอาการเรียนออนไลน์แบบมีเซสชันการสนับสนุนผู้สอนซึ่งสามารถทำได้ทั้งแบบเข้าชั้นเรียนหรือทางออนไลน์เพื่อลดค่าใช้จ่าย', 
    tefl_courses_comments_des23: 'โมดูลที่ 1: ความต้องการ การประเมิน และทฤษฎี',
    ...
    tefl_courses_comments_des243: 'การไตร่ตรองบทเรียนและคำติชมของผู้สอน',
    tefl_courses_comments_des25: 'โมดูลที่ 3: การพัฒนาแบบมืออาชีพอย่างต่อเนื่อง',
    tefl_courses_comments_des251: 'แผนแบบละเอียดสำหรับบทเรียนในอนาคตและการพัฒนาทักษะ',
    tefl_courses_comments_des252: 'งานพัฒนาภาษาที่ออกแบบเฉพาะสำหรับครูแต่ละท่าน ตามความต้องการด้านภาษาและเนื้อหาบทเรียนในอนาคต',
    tefl_courses_comments_des253: 'การสังเกต การทดสอบ และการประเมินแบบเป็นระยะ',
    tefl_courses_comments_des26: 'ระดับภาษาที่ต้องการ: A1+',
    ...
    emi_courses_des11: 'หลักสูตรนี้เป็นหลักสูตรที่จัดทำขึ้นโดยเฉพาะซึ่งจัดทำขึ้นโดยความร่วมมือกับโรงเรียนหรือมหาวิทยาลัยของคุณ หลักสูตรได้รับการออกแบบมาเพื่อให้ข้อมูลเบื้องต้นเกี่ยวกับ EMI และสร้างความสนใจในการศึกษาต่อ เนื้อหามีความยืดหยุ่นอย่างมากและสามารถนำไปใช้งานได้ทั้งทางออนไลน์ แบบผสมผสาน หรือแบบเรียนในห้องเรียน โดยเป็นส่วนหนึ่งของ ‘วันทดลองใช้’',
    emi_courses_des12: 'เนื้อหาของหลักสูตรโดยทั่วไปจะให้ตัวอย่างเทคนิคและภาษาในชั้นเรียนที่มีประโยชน์ ตลอดจนกิจกรรมสนุกๆ เพื่อแสดงให้เห็นว่าบทเรียนสามารถทำให้เป็นแบบโต้ตอบกันได้และมีส่วนร่วมกันได้อย่างไร สามารถใช้บทเรียนที่ออกแบบโดยเฉพาะที่อ้างอิงจากการเรียนการสอนที่สถาบันการศึกษาของคุณนี้ไปเป็นส่วนหนึ่งของแคมเปญการตลาดได้ นอกจากนี้ยังสามารถนำไปใช้เป็นส่วนหนึ่งของโมดูลที่ 1 ของหลักสูตรพื้นฐาน EMI ที่มีเนื้อหามากขึ้น เพื่อส่งเสริมให้ผู้เข้าร่วมได้เรียนรู้เพิ่มเติมต่อไปอีกด้วย',
    ...
    emi_courses_des2: 'หลักสูตรนี้เป็นหลักสูตรแบบผสมผสาน ซึ่งช่วยให้ครูผู้สอนได้มีเครื่องมือสำคัญที่จำเป็นสำหรับการนำเสนอบทเรียนและการบรรยายเป็นภาษาอังกฤษ',
    emi_courses_comments_des21: 'หลักสูตรนี้แบ่งออกเป็นสามโมดูล',
    emi_courses_comments_des211: 'โมดูลที่ 1: กลยุทธ์ เทคนิค และภาษาหลัก',
    emi_courses_comments_des2111: 'การประเมินสถานการณ์การสอน ระดับภาษา และความต้องการ',
    emi_courses_comments_des2112: 'งานออนไลน์เพื่อพัฒนาความตระหนักรู้เกี่ยวกับหลักการของ EMI เทคนิคที่เป็นประโยชน์ และภาษาหลัก',
    emi_courses_comments_des2113: 'เซสชันการอภิปรายและฝึกปฏิบัติร่วมกับที่ปรึกษา',
    emi_courses_comments_des212: 'โมดูลที่ 2: การสอนและการฝึกภาษา',
    emi_courses_comments_des2121: 'ช่วยในการวางแผนบทเรียน',
    emi_courses_comments_des2122: 'สังเกตการปฏิบัติการสอนทั้งแบบสดและแบบบันทึกไว้',
    emi_courses_comments_des2123: 'การการไตร่ตรองบทเรียนและคำติชมของผู้สอน',
    emi_courses_comments_des2124: 'การฝึกปฏิบัติและการประเมินภาษา',
    emi_courses_comments_des213: 'โมดูลที่ 3: การพัฒนาแบบมืออาชีพอย่างต่อเนื่อง',
    emi_courses_comments_des2131: 'แผนแบบละเอียดสำหรับบทเรียนในอนาคตและการพัฒนาทักษะ',
    emi_courses_comments_des2132: 'งานพัฒนาภาษาที่ออกแบบเฉพาะสำหรับครูแต่ละท่าน ตามความต้องการด้านภาษาและเนื้อหาบทเรียนในอนาคต',
    emi_courses_comments_des2133: 'การทดสอบและการประเมิน และทางเลือกสำหรับการสังเกตการณ์เพิ่มเติม',
    ...
    staffs_des: 'นอกจากเความเชี่ยวชาญของเราในด้านการเรียนรู้ภาษา การฝึกอบรมครู และการออกแบบหลักสูตรแล้ว เรายังให้คำปรึกษาและจัดทำหลักสูตรการฝึกอบรมพนักงาน การบูรณาการ AI การตลาดและการเจรจาต่อรอง เราสามารถพัฒนากลยุทธ์องค์กรควบคู่ไปกับทักษะในการสื่อสาร ทำให้บริษัททุกขนาดมีเครื่องมือที่จำเป็นในการแข่งขัน',
    teacher: 'คุณครู',
    education_title: '',
    information_john_c1: 'John มีประสบการณ์ 25 ปีในอุตสาหกรรม ELT อีกทั้งยังเป็นผู้ฝึกอบรมครู CELTA ของ Cambridge University เป็นเวลากว่า 15 ปีแล้ว หลังจากสำเร็จการศึกษาระดับปริญญาตรีสาขาภาษาอังกฤษจากมหาวิทยาลัยลอนดอน Johnได้รับคุณวุฒิ ELT แรกจากคุณวุฒิทั้งสี่ในปี 1999 นับตั้งแต่นั้นมาเขาได้ทำงานในหลายประเทศทั่วโลก และใช้เวลากว่า 10 ปีในประเทศไทยในโครงการฝึกสอนครูสำหรับ International House, ECC และ British Council ในปี 2012 จอห์นได้เป็นผู้ประเมิน Cambridge University CELTA ซึ่งทำการตรวจสอบหลักสูตร CELTA ทั่วโลก เขาได้ออกแบบหลักสูตรการสอนและการฝึกอบรมจำนวนมาก และสามารถผสมผสานความเข้าใจอันดีในวัฒนธรรมไทยกับประสบการณ์ที่มีมากมายเกี่ยวกับเทรนด์และเทคนิคการสอนระดับสากล',
    information_john_c2: '',
    information_john_c3: '',
